...
Email:  kberko4@wgu.edu
Student Application version:  QAM1 - Post 09-15-2020
Date:  06-01-2021
...
Load and run: Download JDK 13.0.1 if not already downloaded. Download JavaFX 11.0.2 if not already downloaded. Load the program into intelliJ and ensure
              you have have the libraries of JavaFX and mysql-connector-java-8.0.22. You can search for mysql driver in the project settings->libraries
              section. Ensure you build path has a path to libraries and is targeting java 13.
              Build path: --module-path ${PATH_TO_FX} --add-modules javafx.fxml,javafx.controls,javafx.graphics
                          (make sure you modify the path to the libraries where they are stored on your machine)

Additional Report: The additional report will provide the customer that is associated with the most appointments and give the amount of appointments
                   that the customer is associated with.